...
use app\modules\other\service\LinkService;
 ...
 */
class LinkController extends UserBaseController
{
    /**
    ...
    public function actionIndex()
    {
        if(Yii::$app->request->isAjax) {
            ...
            $list = $model->getLinkList($search['value'], $orderBy, $limit, $offset);
            $count = $model->getLinkCount();
