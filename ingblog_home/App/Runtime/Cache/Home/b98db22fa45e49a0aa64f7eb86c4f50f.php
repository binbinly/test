            ...
            <nav class="navbar navbar-inverse navbar-static-top">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="<?php echo U('photo');?>">生活趣事</a></li>
...
<div class="service">
	<div class="container">
		<div class="service-main">
			<div class="service-top wow fadeInDownBig" data-wow-delay="0.3s">
				<h1>Services</h1>
				<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore.</p>
			</div>
			<div class="service-left">
			   <div class="col-md-6 service-right wow slideInLeft" data-wow-delay="0.3s">
				   <div class="item item-type-move">
						...
						<div class="item-img">
								<img src="/ingblog_home/Public/images//s3.jpg" class="img-responsive" alt="">
						</div>
					</div>
			    ...
			    <div class="col-md-6 service-right wow slideInRight" data-wow-delay="0.3s">
				   <div class="item item-type-move">
						<a class="item-hover" href="#">						
							<div class="item-info">
								<div class="headline">
						...
						<div class="item-img">
								<img src="/ingblog_home/Public/images//s2.jpg" class="img-responsive" alt="">
						</div>
					</div>
				    <p>when an unknown printer took a galley of type and scrambled it to make a type specimen book.It has survived not only five centuries</p>
				    <div class="ser-bwn">			    	
...
<div class="ser-strip">
	<div class="container">
		<div class="ser-strip-main wow rollIn" data-wow-delay="0.3s">
		    ...
		    <a href="single.html" class="hvr-underline-from-left">Read More</a>
		</div>
	</div>
</div>
<!--serstrip-->
		...
		<div class="train-ser-main">
			...
			<div class="train-ser-bottom wow slideInRight" data-wow-delay="0.3s">
				<div class="col-md-4 train-grid">
				  <div class="trin-top-grid">
					<div class="ser-setting">
					  <img src="/ingblog_home/Public/images//s4.jpg" alt="" class="img-responsive">
					       <div class="captn">
								<h4>Our Class</h4>	
				...
				<div class="col-md-4 train-grid">
				  <div class="trin-top-grid">
					<div class="ser-setting">
					  <img src="/ingblog_home/Public/images//s5.jpg" alt="" class="img-responsive">
					       <div class="captn">
								<h4>Our Class</h4>	
								<p>February 29, 2016</p>						
							</div>
				...
				<div class="col-md-4 train-grid">
				  <div class="trin-top-grid">
					<div class="ser-setting">
					  <img src="/ingblog_home/Public/images//s6.jpg" alt="" class="img-responsive">
					       <div class="captn">
								<h4>Our Class</h4>	
								<p>February 29, 2016</p>						
							</div>
