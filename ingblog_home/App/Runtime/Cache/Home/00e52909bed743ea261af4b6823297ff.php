...
<!--banner start here-->
 <div class="banner">
 		<div class="ser-strip">
	<div class="container">
		<div data-wow-delay="0.3s" class="ser-strip-main wow rollIn animated" style="visibility: visible; animation-delay: 0.3s; animation-name: rollIn;">
		    ...
		    <a class="hvr-underline-from-left" href="single.html">Read More</a>
		</div>
	</div>
</div>
 </div>
...
<div class="bann-grid">
	<div class="container">
		<div class="bann-grid-main wow bounceInRight" data-wow-delay="0.3s">
			<?php if(is_array($photo)): foreach($photo as $key=>$item): ?><div class="col-md-3 bann-works">
				<a href="<?php echo U('photoDetail', array('id'=>$item['id']));?>">
